                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <Nav className="me-auto">
                                {
                                    user ? <Nav.Link as={Link} to='additem' className='mx-2' href="#additem"> <h4>Add New</h4></Nav.Link> : ''
                                }

                                {
                                    user ? <Nav.Link as={Link} to='myitems' className='mx-2' href="#myitems"> <h4>My Items</h4></Nav.Link> : ''
                                }

                                {
                                    user ? <Nav.Link as={Link} to='manage' className='mx-2' href="#manage"><h4>Manage</h4></Nav.Link> : ''
                                }
                                {
                                    user ? <button onClick={handleSignOut} className='mx-3 px-3 space-message text-white'><h4> Sign Out</h4></button> : <Nav.Link as={Link} to='login' className='mx-3 px-3 space-message text-white' href="#login"><h4>Log In</h4></Nav.Link>
                                }
